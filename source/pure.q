...
distance_table: select id,estacion:station_index from traffic_station;
...
t:select [20] carga from complete;
/ WIP
mdl1:.ml.ts.SARIMA.fit[1700#complete[`carga];1700#complete[`fecha];numLags;integrate;mavgVals;isTrend;seasDict]
